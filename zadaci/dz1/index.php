							...
							<div class="span6">
								...
								<div id="divHeaderText" class="page-content">
									...
									<div id="divHeaderLine3">
										<a class="btn btn-large btn-secondary" href="#">Sekundarno dugme</a>   <a class="btn btn-large btn-primary" href="#">Primarno dugme</a>
									</div>
								</div>
				...
				<div class="divPanel notop page-content">
					...
					<div class="row-fluid">
						...
						<div class="span12" id="divMain">
							...
							<p>
								Content on this page is for presentation purposes only. Lorem Ipsum is simply dummy text of the printing and typesetting industry.
