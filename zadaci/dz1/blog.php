            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div id="divLogo">
                        ...
                        <a href="index.php" id="divTagLine">predložak</a>
                    </div>
                    ...
                    <div class="navbar">
                        ...
                        <div class="nav-collapse collapse">
                            <ul class="nav nav-pills ddmenu">
                                ...
                                <li class="dropdown active"><a href="blog.php">Blog</a></li>
    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="index.php">Početna</a> &nbsp;/&nbsp; <span>Blog</span>
            </div>
