...
insert into korisnik (oib,ime,prezime) values (78954787457,'Željko','Pervan');drop database if exists ljekarna;
create database ljekarna default character set utf8;
use ljekarna;
...
insert into operater (korisnik, korisnicko_ime, lozinka,ljekarna) values (1, 'mb', '1234', 1);
insert into operater (korisnik, korisnicko_ime, lozinka,ljekarna) values (2, 'ip', '1234', 1);
insert into operater (korisnik, korisnicko_ime, lozinka,ljekarna) values (3, 'db', '1234', 1);
insert into operater (korisnik, korisnicko_ime, lozinka,ljekarna) values (4, 'rb', '1234', 1);
